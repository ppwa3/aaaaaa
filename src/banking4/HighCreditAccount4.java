...
import banking3.ICustomDefine3;

public class HighCreditAccount4 extends Account4 {
	...
	public String toString() {
		return "HighCreditAccount4" + super.toString() + ", 이자=" + intInformation + ", 신용등급=" + creDitRat + "]";
	}

	public HighCreditAccount4(String accountNum, String name, int balance, int intInformation, String creDitRat) {
